...
int main (int argc, char** argv) {
  ...
  model->SetSummaryFile("summary_knockout_regression_five_layers",argv[14]);
...
string weight_filename = "model_weights_knockout_regression_five_layers_";
...
TCanvas *reso_canvas = new TCanvas("reso_canvas","Resolution Canvas");
 ...
 std::ofstream outFile("results_five_layer_model.txt", std::ios::app);
 outFile<<argv[14]<<" ";
 ...
 outFile.close();
  ...
  TString filename = "training_results_knockout_regression_five_layers_";
